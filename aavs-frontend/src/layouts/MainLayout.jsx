      ...
      <div className="flex-1 min-w-0 flex flex-col">
        ...
        <header className="h-16 px-6 border-b border-purple-800/30 bg-slate-900/60 backdrop-blur-xl flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Alerts */}
            <button className="relative h-10 w-10 rounded-xl bg-slate-800/70 border border-slate-700 flex items-center justify-center hover:bg-slate-700/70 transition">
              <Bell size={17} />
